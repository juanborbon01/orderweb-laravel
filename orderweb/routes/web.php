...
Route::prefix('causal')->group(function(){
    ...
    Route::put('/destroy/{id}',[CausalController::class, 'destroy'])->name('causal.destroy');
});
/**/ 
Route::prefix('observation')->group(function(){
    ...
    Route::put('/destroy/{id}',[ObservationController::class, 'destroy'])->name('observation.destroy');
});
/**/ 
Route::prefix('type_activity')->group(function(){
    ...
    Route::put('/destroy/{id}',[TypeActivityController::class, 'destroy'])->name('type_activity.destroy');
});
/**/ 
Route::prefix('activity')->group(function(){
    ...
    Route::put('/destroy/{id}',[ActivityController::class, 'destroy'])->name('activity.destroy');
});
/**/ 
Route::prefix('technician')->group(function(){
    ...
    Route::put('/destroy/{document}',[TechnicianController::class, 'destroy'])->name('Technician.destroy');
});
/**/
Route::prefix('order')->group(function(){
    ...
    Route::get('/add_activity_id/{order_id}/{activity_id}',[OrderController::class, 'add_activity'])->name('order.add_activity');
    Route::get('/remove_activity_id/{order_id}/{activity_id}',[OrderController::class, 'remove_activity'])->name('order.remove_activity');
});
