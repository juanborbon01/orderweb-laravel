                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('auth.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="name" name="name" placeholder="Nombre completo" required value="{{ old('name') }}">
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="email" name="email" placeholder="Correo electrónico" required value="{{ old('email') }}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <hr>                                    
                                    <div class="text-center">
                                        <a class="small" href="{{ route('auth.index') }}">Iniciar sesión</a>
                                    </div>
                                </div>
                            </div>
                        </div>
